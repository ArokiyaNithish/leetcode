...
Game Over
 Read more8212345Copyright © 2026 LeetCode. All rights reserved.71544373 OnlinePython3Auto49505152535455565758                    if m < j:                        res = max(res, max_r[m + 1][j])                                        dp[i][j] = res                                # Update the auxiliary arrays for future queries                max_l[i][j] = max(max_l[i][j - 1], total_sum + dp[i][j])                max_r[i][j] = max(max_r[i + 1][j], total_sum + dp[i][j])                        return dp[0][n - 1]SavedLn 58, Col 28AcceptedRuntime: 0 msCase 1Case 2Case 3InputstoneValue =[6,2,3,4,5,5]Output18Expected18Contribute a testcaseInput9123›[6,2,3,4,5,5][7,7,7,7,7,7,7][4]Output9123›18280Expected9123›18280 All SubmissionsAccepted132 / 132 testcases passedArokiya Nithish Jsubmitted at Aug 17, 2026 05:42AnalysisSolution👑 Unlock the Full LeetCode ExperienceCompany problems, Ask Leet, and expert editorials — all in one plan.Runtime594msBeats79.21%Memory33.01MBBeats67.06%Created with Highcharts 11.1.060ms1253ms2446ms3638ms4831ms6024ms7217ms8409ms0%5%10%
                  
                Created with Highcharts 11.1.060ms1253ms2446ms3638ms4831ms6024ms7217ms8409msCodePython31from typing import List
2
3class Solution:
...
57                
58        return dp[0][n - 1]View more More challenges1406. Stone Game III1690. Stone Game VII2029. Stone Game IX0/5FindHeaderBarSizeFindTabBarSizeFindBorderBarSize
